...
(
	...
	PARTS_CONTINUOUS		CHAR (1) NOT NULL CHECK (PARTS_CONTINUOUS_NUM IN (0, 1)),
	PARTS_SHOW_PRES			CHAR (1) NOT NULL CHECK (PARTS_SHOW_PRES IN (0, 1)),
...
CREATE TABLE MNEME_ASSESSMENT_DRAW_PICK
(
