...
(
	...
	TIME_LIMIT				NUMBER UNSIGNED,
	TITLE					VARCHAR2 (255),
	TRIES					NUMBER UNSIGNED,
...
(
	ASSESSMENT_ID			NUMBER UNSIGNED NOT NULL,
	DATES_ACCEPT_UNTIL		NUMBER,
	DATES_DUE				NUMBER,
	DATES_OPEN				NUMBER,
	ID						NUMBER UNSIGNED NOT NULL PRIMARY KEY,
...
(
	ASSESSMENT_ID			NUMBER UNSIGNED NOT NULL,
	NUM_QUESTIONS_SEQ		NUMBER UNSIGNED,
	ORIG_PID				NUMBER UNSIGNED,
	ORIG_QID				NUMBER UNSIGNED,
	PART_ID					NUMBER UNSIGNED NOT NULL,
	POOL_ID					NUMBER UNSIGNED,
	QUESTION_ID				NUMBER UNSIGNED
);
