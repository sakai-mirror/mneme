...
/**
 * NonsubPlugin handles the Nonsub question type.
 */
public class NonsubPlugin implements QuestionPlugin
{
	private static Log M_log = LogFactory.getLog(NonsubPlugin.class);
	...
	{
		return new NonsubAnswerImpl(answer);
	}
